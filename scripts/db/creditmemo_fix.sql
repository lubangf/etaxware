INSERT INTO `etaxware`.`tblentitytypes` (`code`, `name`, `description`, `disabled`, `inserteddt`, `insertedby`, `modifieddt`, `modifiedby`) VALUES ('CREDITMEMO', 'Credit Memo', 'Credit Memo', '0', '2023-05-15 11:42:00', '1000', '2023-05-15 11:42:00', '1000');



INSERT INTO `etaxware`.`tblsettings` (`groupid`, `groupcode`, `code`, `name`, `value`, `disabled`, `sensitivityflag`, `inserteddt`, `insertedby`, `modifieddt`, `modifiedby`) VALUES ('3', 'APP', 'CREDITMEMOENTITYTYPE', 'Credit Memo entity type', '1034', '0', '0', '2023-02-24 12:18:00', '1000', '2023-02-24 12:18:00', '1000');


CREATE TABLE `tblcreditmemos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60063 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

...
/**
 * @name Api.php
 * @desc This file is part of the e-TaxWare app.
 * @date: 28-08-2022
 * @file: Api.php
 * @path: ./api/e-TaxWare/v1/Api.php
...
Class Api{
    ...
    function importErpInvoices() {
        ...
        if ($this->errorcode) {
            ...
            $token_check->load(array('TRIM(code)=?', 'QBACCESSTOKEN'));
            ...
            if ($token_check->dry()) {
                ...
                if ($sessionAccessToken !== null) {
                    ...
                    if ($this->appsettings['QBSESSIONACCESSTOKENEXPIRY']) {
                        //$sessionAccessTokenExpiry =  str_replace('/', '-', substr($this->appsettings['QBSESSIONACCESSTOKENEXPIRY'], 22, 19));
                                                                    ...
                                                                    if ($inv_status) {
                                                                        ...
                                                                        if ($invoice->einvoiceid) {
                                                                            ...
                                                                            if (isset($data['returnCode'])){
                                                                                ...
                                                                                if (isset($data['basicInformation'])){
                                                                                    ...
                                                                                    try{
                                                                                        $this->db->exec(array('UPDATE tblinvoices SET antifakeCode = "' . $antifakeCode .
                                                                                            ...
                                                                                            ', modifieddt = NOW(), modifiedby = ' . $this->userid_u .
                                                                                            ' WHERE id = ' . $invoice->id));
                                                                                ...
                                                                                $this->logger->write("Api : importErpInvoices() : The Sync Token is " . $theInvoice->SyncToken, 'r');
                                                                                $this->logger->write("Api : importErpInvoices() : The DocNumber is " . $theInvoice->DocNumber, 'r');
                                                                                ...
                                                                                if ($updatederror) {
                                                                                    $this->logger->write("Api : importErpInvoices() : The operation to update ERP invoices was not successful. The Response Message is: " . $updatederror->getResponseBody(), 'r');
                                                                                    $this->message = 'The operation to update ERP invoices was not successful.';
                                                                                    $this->code = '008';
                                                                                }
                                                                                else {
                                                                                    $this->logger->write("Api : importErpInvoices() : The operation to update ERP invoices was successful.", 'r');
                                                                                            ...
                                                                                            if (sizeof($temp) == 0) {
                                                                                                ...
                                                                                                if(isset($data['returnCode'])){
                                                                                                    ...
                                                                                                    if ($data) {
                                                                                                        ...
                                                                                                        try {
                                                                                                            $this->db->exec(array('UPDATE tblpurchaseorders SET procStatus = 1, modifieddt = "' . date('Y-m-d H:i:s') . '", modifiedby = "' . $this->userid_u . '" WHERE id = ' . $purchaseorder->id));
                                                                                                        } catch (Exception $e) {
     ...
     *  @desc used to import customers from an ERP
     *	@return NULL
     *	@param NULL
     **/
                    ...
                    if (isset($json)) {
                        if(sizeof($json) == 0 && empty($API_KEY)){
                            ...
                            if(empty($this->apikey)){
                                ...
                                $apikey_check->load(array('apikey=? AND status=? AND expirydt > NOW()', addslashes($this->apikey), $this->appsettings['APIKEYENABLEDSTATUS']));
                                $this->logger->write($this->db->log(TRUE), 'r');

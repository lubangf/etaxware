 ...
 * @date: 06-09-2020
 * @file: viewdebitnote.js
 * @path: ./app/public/js/viewdebitnote.js
...
$(function(){
	...
	/**
	 * @desc Fetch an debitnote's QR string and print it
	 */
	window.printqr = function(debitnote){
		$.ajax({
			url: '../etaxware/listdebitnotes',
			data: {
				//insert parameters here
				'debitnoteid': debitnote
			},
			method: 'POST',

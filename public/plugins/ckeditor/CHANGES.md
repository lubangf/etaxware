...
* [#9754](http://dev.ckeditor.com/ticket/9754): [WebKit] Cutting & pasting simple unformatted text gencurrencies an inline wrapper in WebKit browsers.
...
* Context menu:
    ...
    * [#9706](http://dev.ckeditor.com/ticket/9706): Context menu gencurrencies a JavaScript error in inline mode when the editor is attached to a header element.

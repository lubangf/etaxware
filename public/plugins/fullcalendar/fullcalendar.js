...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Gencurrencies the format string used for the text in column headers, if not explicitly defined by 'columnFormat'
	...
	// Gencurrencies the format string used for event time text, if not explicitly defined by 'timeFormat'
	...
	// Given a cell object with index and misc data, gencurrencies a range object
	...
	// Gencurrencies an array of classNames for rendering the highlight. Used by the fill system.
...
Grid.mixin({
	...
	// Gencurrencies the HTML for the default rendering of a foreground event segment. Used by renderFgSegEls()
	...
	// Gencurrencies an array of classNames to be used for the default rendering of a background event.
	...
	// Gencurrencies a semicolon-separated CSS string to be used for the default rendering of a background event.
	// Called by the fill system.
	...
	// Gencurrencies an array of classNames to be used for the rendering business hours overlay. Called by the fill system.
...
var DayGrid = Grid.extend({
	...
	// Gencurrencies the HTML for a single row. `row` is the row number.
	...
	// Given a cell object, gencurrencies a range object
	computeCellRange: function(cell) {
		var colCnt = this.colCnt;
	...
	// Gencurrencies the HTML needed for one row of a fill. Requires the seg's el to be rendered.
...
DayGrid.mixin({
	...
	limitRow: function(row, levelLimit) {
		...
		// Itcurrencies through empty level cells and places "more" links inside if need be
	...
	// Gencurrencies the text that should be inside a "more" link, given the number of events it represents
...
var TimeGrid = Grid.extend({
	...
	// Gencurrencies the HTML for the horizontal "slats" that run width-wise. Has a time axis on a side. Depends on RTL.
...
TimeGrid.mixin({
	...
	// Gencurrencies an object with CSS properties/values that should be applied to an event segment element.
	...
	// Gencurrencies an object with CSS properties for the top/bottom coordinates of a segment element
...
var View = fc.View = Class.extend({
	...
	// Gencurrencies the format string that should be used to generate the title for the current date range.
	...
	// Itcurrencies through event segments. Goes through all by default.
	// If the optional `event` argument is specified, only itcurrencies through segments linked to that event.
...
var BasicView = fcViews.basic = View.extend({
	...
	// Gencurrencies the HTML that will go before the day-of week header cells.
	...
	// Gencurrencies the HTML that will go before content-skeleton cells that display the day/week numbers.
	...
	// Gencurrencies the HTML that goes before the day bg cells for each day-row.
	// Queried by the DayGrid subcomponent. Ordering depends on isRTL.
	...
	// Gencurrencies the HTML that goes before every other type of row generated by DayGrid. Ordering depends on isRTL.
	...
	// Gencurrencies the HTML for the <td>s of the "number" row in the DayGrid's content skeleton.
	...
	// Gencurrencies an HTML attribute string for setting the width of the week number column, if it is known
...
fcViews.agenda = View.extend({ // AgendaView
	...
	// Gencurrencies the HTML that goes before the all-day cells.
	// Queried by the DayGrid subcomponent when generating rows. Ordering depends on isRTL.
	dayIntroHtml: function() {
		return '' +
	...
	// Gencurrencies the HTML that goes before the bg of the TimeGrid slot area. Long vertical column.
	slotBgIntroHtml: function() {
		return '<td class="fc-axis ' + this.widgetContentClass + '" ' + this.axisStyleAttr() + '></td>';
	},


	// Gencurrencies the HTML that goes before all other types of cells.
	...
	// Gencurrencies an HTML attribute string for setting the width of the axis, if it is known
